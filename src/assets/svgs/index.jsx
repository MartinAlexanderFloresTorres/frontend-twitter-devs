...
export const MessageRigthSvg = ({ ...props }) => {
  return (
...
export const MessageVistoSvg = ({ ...props }) => {
  return (
    <svg {...props} viewBox='0 0 16 15' width='16' height='15'>
      <path
        fill='currentColor'
...
export const FotoSvg = ({ ...props }) => {
  return (
    <svg {...props} width={20} height={16} viewBox='0 0 16 20'>
      <path
        fill='currentColor'
...
export const LoaderSvg = ({ ...props }) => {
  return (
    <div className='spinner center' {...props}>
